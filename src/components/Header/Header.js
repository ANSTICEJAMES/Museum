...
function Header() {
    return (
      <div className="head">
        <Link to="/"><div  className="logo" alt = "Логотип"><img  className="logo" src={logo} alt = "Логотип" ></img></div></Link>
        <div className="info">
          ...
          <div className="logo_sfedu"><img className="logo" src={sfedu} alt = "Логотип"></img></div></a>
      </div>
    );
}
